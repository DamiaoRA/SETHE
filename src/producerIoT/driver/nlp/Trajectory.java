...
public class Trajectory implements Comparable<Trajectory>{
	...
	public void loadText(String valuePoi, String valueCat) throws Exception {
		...
		if(places.length != categories.length)
			throw new Exception("Na trajetória " + id + " o tamanho do value de poi é diferente do value de categoria");
	...
	public void addAspect(String a, String[] text) throws Exception {
		if(text.length != pois.length) {
			throw new Exception("Na trajetória " + id + " o tamanho do aspecto " + a + " é diferente do tamanho da trajetória ");
		}
...
//		System.out.println("");
	...
	private void addVertice(Expression e, PoI p/*List<PoI> listPoIs*/) {
