...
public class QuerySetheTripBuilderMain {
	...
	public static void main(String[] args) throws Exception {
		qt = new QuerySETHEMain("localhost", "5432", "postgres", "lsi123", "tripbuilder");
	...
	private static TimeQ queryQ1() throws Exception {
		...
		prop.setProperty("q1_asp_cat", "museidipisa(;(\\w*))* ; ((\\w*);)*cappelledipisa");
	...
	private static TimeQ queryQ2() throws Exception {
		Properties prop = new Properties();
		prop.setProperty("q1_asp_cat", "(torridipisa)(;(\\w*))* ; ((\\w*);)*(cappelledipisa|chiesedipisa)(;(\\w*))* ; (((\\w*);)*(cappelledipisa|chiesedipisa)(;(\\w*))*) ; ((\\w*);)*(museidipisa)");
		prop.setProperty("q1_proximity", ".*                     ; ~                                                 ; .*                                                ; ~");
	...
	private static TimeQ queryQ3() throws Exception {
		Properties prop = new Properties();
		prop.setProperty("q1_asp_cat", "torridipisa(;(\\w*))* ; ((\\w*);)*museidipisa");
		prop.setProperty("q1_proximity", " .*                  ; ~");
	...
	private static TimeQ queryQ5() throws Exception {
		...
		prop.setProperty("q1_asp_cat", "^((\\w*);)*(museidipisa)(;(\\w*))* ; ((\\w*);)*(cappelledipisa)(;(\\w*))*$");
		prop.setProperty("q1_proximity", ".*			                     ; ~");
	...
	private static TimeQ queryQ6() throws Exception {
		...
		prop.setProperty("q1_asp_cat", "museidipisa(;(\\w*))* ; ((cappelledipisa|chiesedipisa)(;(\\w*))*$)*");
		prop.setProperty("q1_proximity", ".*			        ; .*");
	...
	private static TimeQ queryQ7() throws Exception {
		...
		prop.setProperty("q1_asp_cat", "^(((\\w*);)*(cappelledipisa)(;\\w*)* )(?=(((\\w*);)*)(cappelledipisa)) ; (cappelledipisa)$");
		prop.setProperty("q1_proximity", ".*			       												   ; .*");
	...
	private static TimeQ queryQ9() throws Exception {
		...
		prop.setProperty("q1_asp_cat", "^(((\\w*);)*(cappelledipisa|chiesedipisa)) ; .*");
		prop.setProperty("q1_asp_poi", "  .*              						   ; (Torre_pendente_di_Pisa)$");
		prop.setProperty("q1_asp_move", " .*  									   ; (?-)Bus");
		prop.setProperty("q1_proximity", ".*			      ; .*");
		prop.setProperty("weight_move", "1");
		prop.setProperty("distance_move", "equality");
	...
	private static TimeQ queryQ10() throws Exception {
		...
		prop.setProperty("q1_asp_cat", "^((\\w*);)*(torridipisa) ; \\w+(\\\\w*;*)* ;  ((\\w*);)*(chiesedipisa)(;(\\w*))* ; (palazzidipisa)(;(\\w*))*$");
		prop.setProperty("q1_asp_move", " .*              ; Walk          ; Bus                                 ; .*");
		prop.setProperty("weight_move", "1");
		prop.setProperty("distance_move", "equality");
		prop.setProperty("limit_move", "1");
		return queryQ(prop);
